...
} from '@pusher/pusher-websocket-react-native'; // This links the example app to the current SDK implementation
...
export default function App() {
  ...
  React.useEffect(() => {
    const getFromStorage = async () => {
      onChangeApiKey((await AsyncStorage.getItem('821da38abbc9954afe90')) || '');
      onChangeCluster((await AsyncStorage.getItem('ap2')) || '');
