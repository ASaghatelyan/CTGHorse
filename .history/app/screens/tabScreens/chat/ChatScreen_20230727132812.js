...
import del from 'app/assets/img/del.png';
...
let userInfow = useSelector(
  store =>
    !moment(new Date()).isBefore(
      store.userInfo.subscribtion_expiration_date,
    ) && navigation.replace('Subscribe'),console.log('sssss')
);
    ...
    <SafeAreaView style={styles.content}>
      ...
      <View style={styles.searchView}>
        ...
        {searchText.length <1 ? (
          ...
          <TouchableOpacity style={styles.delIcView} onPress={loadChats}>
