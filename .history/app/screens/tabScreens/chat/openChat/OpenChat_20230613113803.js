          ...
          global.audioMess = new Sound(
            ...
            error => {
              if (error) {
                ...
                global.audioMess.play(() => {
                  // Release when it's done so we're not using up resources
                  global.audioMess.release();
                });
              }
            },
            );
            console.log(global.audioMess, 'dddddffffff');
          return (
            <Bubble
              {...props}
              textStyle={{
              ...
              renderMessageAudio={() => <View style={{width: '100%'}}>
                ...
                <Button title='play' onPress={()=>global.audioMess.play()}/>
              </View>}
            />
          );
        }}
