...
export const OpenChat = () => {
  const [messages, setMessages] = useState([
    ...
    {
      text: 'Gg yakjhgcbasdfaksjdnf asdfasdnf laskdnf lskdjf nsaldkfaslkfnasdlf jknaskldjf nsadjklfn asdklfjklsd nfjklasdnf kljsadf',
      user: {
        _id: 2,
        name: 'John',
        avatar: 'https://images.pexels.com/photos/67636/rose-blue-flower-rose-blooms-67636.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940'
    ...
    return (
      <Bubble
        ...
        wrapperStyle={{
          ...
          right: {
            backgroundColor: 'rgba(228, , 228, 0.83)', 
          },
        }}
      />
    );
