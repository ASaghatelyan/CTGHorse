...
import { renderActions, renderComposer, renderInputToolbar, renderSend } from 'app/components/chatComponent/InputToolbar';
...
const [deleteMessage,setDeleteMessage]=useState(false)
 ...
 let zoomInput = () => {
  this.setState({zoomInputActive: !this.state.zoomInputActive});
};
