...
export const OpenChat = () => {
      ...
      onSend([
        {
          ...
          createdAt: new Date(),
          image:'https://www.timeoutdubai.com/cloud/timeoutdubai/2021/09/11/udHvbKwV-IMG-Dubai-UAE-1-1200x900.jpg',
          user: {
            _id: 1,
            name: 'John',
            avatar: 'https://www.timeoutdubai.com/cloud/timeoutdubai/2021/09/11/udHvbKwV-IMG-Dubai-UAE-1-1200x900.jpg'
          },
        },
      ]);
      setInputValue('');
  ...
  return (
    <View style={styles.container}>
      ...
      <GiftedChat messages={messages} onSend={onSend} user={{_id: 1,avatar:''}}  avatarStyle= {{
