...
import {Bubble, GiftedChat, InputToolbar,Composer} from 'react-native-gifted-chat';
    ...
    <View style={{flex: 1}}>
      ...
      <View style={{flex: 1}}>
        ...
        <View style={{flex: 1, marginBottom: 35}}>
          <GiftedChat
          renderComposer={(props) => <Composer textInputStyle={{color: 'blue',backgroundColor:"red"}} {...props} />}
            messages={messages}
