...
export function OpenChat(props) {
  return (
    <SafeAreaView>
      ...
      <ScrollView contentContainerStyle={{flexGrow: 1, paddingBottom: 40,paddingHorizontal:15}}>
        <View style={styles.leftChatView}>
          ...
          <View style={styles.leftTextView}>
            <Text>asdadasda  sasdas dasddadas dasda dasdaadsa sda sdasd sd sd sd sd s d sds dsd </Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
