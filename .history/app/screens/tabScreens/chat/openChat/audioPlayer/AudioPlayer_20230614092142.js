...
export function AudioPlayer({url, id, stopMusic}) {
  ...
  const player = useAudioHelper({
    listSounds: [
        { type: 'network', path: 'https://raw.githubusercontent.com/uit2712/RNPlaySound/develop/sounds/Tropic%20-%20Anno%20Domini%20Beats.mp3', name: '', },
    ],
    timeRate: 15,
    isLogStatus: true,
});
