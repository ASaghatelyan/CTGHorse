...
import {Bubble, GiftedChat, InputToolbar,renderSystemMessage} from 'react-native-gifted-chat';
...
export function OpenChat({navigation, route}) {
  ...
  const subscribeToPusher = async () => {
    ...
    var channel = pusher.subscribe('chat' + userInfo.id);
  ...
  return (
    <KeyboardAvoidingView style={{flex: 1}} behavior="padding">
      ...
      <GiftedChat
        ...
        renderSystemMessage={renderSystemMessage(...props)}
        // renderMessage={props =>
        //   renderMessage({
        //     ...props,
