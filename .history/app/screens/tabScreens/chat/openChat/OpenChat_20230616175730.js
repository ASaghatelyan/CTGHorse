...
export function OpenChat({navigation, route}) {
  ...
  const onSend = useCallback(async (newMessages = []) => {
    try {
      ...
      const response = await axios.post('https://1296.freelancedeveloper.site/api/messages/send', data,{
        headers:{
          Authorization:  `Bearer`:'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..Z3qrGnLKk6BTOg5DhlUpeq700a_Sgj-fFqCF_PV24FXUX2rkqdnNNuNNu0VoV2OP8Ihz7h2nK0X1Ao7mxOe5dPjVMYEwrrqnVmo4yvZvUmOKIk4AX2hnZ8FF-LDBWSIaQbDovYQRr1OoS6vqzk0Tu6b5WZ7DbNnhCh_YNO-vEd4uQykGsFajWVhdYXiqc59Fh1EF_RYk-D78GL57LGzMkQ43lUnc9nRz_p5Gq_lQME2oCLhNF50x5ysQs2drQynFhi0U6m1Oo_znARaQboBi6Ju1JL0ZLTJm-ArkK3bhGMGXc_r7BkV051qjqgz8M6O1dZoKqTfi11vkKtJv31yT97qQ_Ci309cpKCcCZ6MzVyMAThf0GjrQBGoBRQPvkqMMq2MSdY-WQZ6cyV-mtWw-satcQ1S8bkGLDZX5mWRWgnhUhk6Ve2yZAlrMxsy8bX8BUMD579X8HoJk9RH6RBNN3CZI2brWbLKa4NP_ZKd6nHAGNeGRMN2R_sHsYhewl01S6gsUmU38u9pRGt2X9WQQGro0jdCavvm6AR-1kwrk8_VcdLvHK0MImAKpULtcwBfev0auZSXT_6Egk1FndQij4P2N2t6mtinxDfNi8laD3hRSOn-D4e1dOG0LIKXc2H7r85fgyCiGtPgCjjuGGVRN_mfxwKU0CYnBkNTmiITeWfU'
        }
      });
  ...
  useEffect(() => {
    loadChats();
    return async () => {
      //  return await pusherInfo?.unsubscribe(`my-channel-22-21`);
    };
  }, []);
  ...
  const subscribeToPusher = async () => {
    ...
    let pusher = new Pusher('207299b65d997a17e4b2', {
      cluster: 'ap2',
      // authEndpoint:
      //   'https://5704.freelancedeveloper.site/api/broadcasting/auth',
      encrypted: true,
    });
    var channel = pusher.subscribe(`my-channel-21-22`);
    console.log(channel);
    pusher.bind(
      'my-event',
      d => {
