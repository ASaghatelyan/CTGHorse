  ...
  return (
    <KeyboardAvoidingView style={{flex: 1}} behavior="padding">
      ...
      <GiftedChat
        ...
        renderBubble={props => {
          console.log(props.currentMessage.audio,'dddddffffff');
          global.audioMess = new Sound (props.currentMessage.audio, undefined,
            error => {
              if (error) {
                console.log(error)
              } else {
          ...
          return (
            <Bubble
              ...
              renderMessageAudio={() => <View style={{ width: '100%',   }}> 
        ...
        messagesContainerStyle={{backgroundColor: '#F5F5F5',paddingHorizontal:10}}
