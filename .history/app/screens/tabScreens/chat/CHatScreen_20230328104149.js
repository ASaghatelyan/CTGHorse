...
export function ChatScreen(props) {
  ...
  return (
    <View>
      ...
      <View >
        <Text style={styles.rece}>Recent Chats</Text>
        <ScrollView contentContainerStyle={{flexDirection:'row',paddingHorizontal:15}} horizontal={true} showsHorizontalScrollIndicator={false} >
          {data.map((item, index) => {
            return (
