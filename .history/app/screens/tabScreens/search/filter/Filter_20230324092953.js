...
export function Filter({navigation}) {
  let [colors, setColors] = useState(JSON.parse(JSON.stringify(color)));
  let [sexs, setSexH] = useState(JSON.parse(JSON.stringify(sex)));
  let [heghts,setHeghtH]
    ...
    <View>
      ...
      <View style={styles.itemsView}>
        ...
        <FilterItem
          ...
          info={colors}
          onReset={() => {
            setColors(JSON.parse(JSON.stringify(color)));
          }}
        ...
        <FilterItem
          ...
          navigation={navigation}
          onReset={() => {
            setColors(JSON.parse(JSON.stringify(sexs)));
          }}
          saveInfo={d => {
            setAllData([...allData, ...d]);
          }}
