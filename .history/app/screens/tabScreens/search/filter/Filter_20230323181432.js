  ...
  return (
    <View>
      ...
      <ScrollView
        ...
        {allData.map((item, index) => {
          return (
            <View style={styles.filtered}>
              ...
              <Text numberOfLines={1} style={styles.choosedText}>{item.title}</Text>
            </View>
          );
        })}
      </ScrollView>
        ...
        />
        <FilterItem text="Height" info={height} navigation={navigation} saveInfo={d => {
            setAllData([...allData, ...d]);
          }} />
        <FilterItem text="Weight" info={weight} navigation={navigation}  saveInfo={d => {
            setAllData([...allData, ...d]);
          }}/>
        <FilterItem text="Earnings" info={price} navigation={navigation} saveInfo={d => {
            setAllData([...allData, ...d]);
          }} />
        <FilterItem text="Breed" info={breed} navigation={navigation}  saveInfo={d => {
            setAllData([...allData, ...d]);
          }}/>
