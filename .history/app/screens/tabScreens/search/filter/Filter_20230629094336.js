      ...
      <View style={styles.itemsView}>
        <ScrollView
          ...
          {allData.map((item, index) => {
            return (
              <View style={styles.filtered} key={item.id}>
                <TouchableOpacity
        ...
        <FilterItem
          ...
          data={JSON.parse(JSON.stringify(sexH))}
          saveInfo={d => {}}
        />
        <FilterItem
          addFilter={addFilter}
        ...
        <GButton
          ...
          handelMove={async () => {
            try {
              ...
              let res = await axiosInstance.post(`/filter`, formData); 
              route.params.onConfirmFilters(res.data, allData.length, arr);
              navigation.goBack();
            } catch (error) {
              console.log(error);
            }
