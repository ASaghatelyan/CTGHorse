...
import add from 'app/assets/img/addH.png';
...
export function ProfileScreen(props) {
  return (
    <View>
      ...
      <ScrollView
        contentContainerStyle={{flexGrow: 1, minHeight: '90%'}}
        ...
        <View style={styles.gFlex}>
          <View style={styles.rateView}>
            <Text style={styles.rateText}>✋Hey Jane, It seems like you have not added any horses yet.</Text>
            <TouchableOpacity>
              <Image/>
            </TouchableOpacity>
          </View>
