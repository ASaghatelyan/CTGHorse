...
export function ChangeHorseInfo({navigation, route}) {
  ...
  let onDelet= async()=>{
try {
  let res = await axiosInstance.post(`/delete-horse/${userHorseInfo.id}`, formData);
    ...
    <View style={styles.content}>
      ...
      <ScrollView
        ...
        <View style={styles.deleteView}>
          <TouchableOpacity style={styles.delView} onPress={()=>setModalVisibleDelete(!modalVisibleDelete)}>
      ...
      <GeneralModal
        ...
        onRightFunc={() => {setModalVisibleDelete(!modalVisibleDelete)}}
