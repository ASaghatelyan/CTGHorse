...
import {ChangePhotoModal, DropDownItem, HeaderNavi, InputHorseReg} from 'app/components';
...
import { OhNoModal } from 'app/components/modal/ohNoModal/OhNoModal';

export function ChangeHorseInfo({navigation, route}) {
    const [modalVisible,setModalVisible]=useState(false)
    const [changePic,setChangePicModal]=useState(false)
