    ...
    <View style={styles.content}>
      ...
      <ScrollView
        ...
        <ImageBackground
          ...
          <TouchableOpacity style={styles.chooseBtn} onPress={()=>setChangePicModal(!changePicModal)}>
        ...
        <View style={styles.addPicVid}>
          <TouchableOpacity style={styles.addView} onPress={() => setModalVisible(!modalVisible)}>
