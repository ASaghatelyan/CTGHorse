...
export function ChangeHorseInfo({navigation, route}) {
  ...
  let next = async () => {
    try {
      ...
      formData.append('registration_number', regn);
      formData.append('date_of_birth', userInfo.date);
      formData.append('breed', userInfo.breed);
      ...
      formData.append('training', userInfo.training);
      formData.append('earnings', userInfo.earnings);
      formData.append('produced_earnings', userInfo.producedEarnings);
      formData.append('condition', userInfo.condition);
      formData.append('location', userInfo.location);
      userInfo.description && formData.append('description', userInfo.description);
      userInfo.sire && formData.append('sire', userInfo.sire);
      userInfo.dam && formData.append('dam', userInfo.dam);
