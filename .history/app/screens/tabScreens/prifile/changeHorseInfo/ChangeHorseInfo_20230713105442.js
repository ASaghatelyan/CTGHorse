              ...
              if (item.types === 'photos') {
                return (
                  <>
                    ...
                    <ReactNativeModal style={{margin:0,backgroundColor:'#000',paddingTop:20}} visible={fullScreenModal} transparent={true}  >
                      <TouchableOpacity  onPress={() => setFullScreenModal(!fullScreenModal)} >
