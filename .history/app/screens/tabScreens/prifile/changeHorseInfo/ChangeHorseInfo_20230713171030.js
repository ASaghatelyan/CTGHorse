...
export function ChangeHorseInfo({navigation, route}) {
  ...
  const [choosedVideo, setChoosedVideo] = useState('');
  ...
  console.log( choosedVideo, 'rrrrrrrr');
  return (
          ...
          {videos.map((item, index) => {
            return (
              <TouchableOpacity
                ...
                <ReactNativeModal
                  style={styles.modal}
                  visible={fullScreenVideoModal}
                  transparent={true}>
                  {/* <VideoPlayer
                    video={{uri: choosedVideo}}
                    style={styles.vid}
                    disableFullscreen
                    ignoreSilentSwitch={'ignore'}
                  /> */}
                  {/* <Video
                    video={{uri: 'https://5704.freelancedeveloper.site/media/New_1689251218357/videos/video1.mp4'}}
                    style={styles.vid}
                    disableFullscreen
                    ignoreSilentSwitch={'ignore'}
                    controls={true}
                  /> */}
                  <Text style={{color:'red'}}>ddfsfsd</Text>
                  <View style={styles.bottomModal}>
                    <TouchableOpacity
                      onPress={() => {
                        setIds([...ids, item.id]);
                        deleteVideo(item.id, index);
                        setFullScreenVideoModal(!fullScreenVideoModal);
                      }}>
                      <Image source={rbin} style={styles.rbin} />
                    </TouchableOpacity>
                    <TouchableOpacity
