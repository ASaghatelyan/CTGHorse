              ...
              if (item.types === 'photos') {
                return (
                  <>
                    ...
                    <ReactNativeModal style={{margin:0}} visible={fullScreenModal} transparent={true}  >
                      <ImageViewer imageUrls={img} onCancel={()=><Text style={{color:'red'}}>sdsdafwgsdf sdraefs</Text>}/>
                      <TouchableOpacity
