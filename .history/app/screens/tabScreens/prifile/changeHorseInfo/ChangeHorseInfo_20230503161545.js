...
export function ChangeHorseInfo({navigation, route}) {
  ...
  let addDoc = async () => {
    try {
      ...
      newDoc.fileName = imageRes.assets[0].fileName;
      newDoc.url = imageRes.assets[0].uri;
      newDoc.type = imageRes.assets[0].type;
      console.log(files,'ffffsdfsdfsdfsfsdff');
