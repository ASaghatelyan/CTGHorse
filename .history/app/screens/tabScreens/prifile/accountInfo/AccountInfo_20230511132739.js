      ...
      <ScrollView
        ...
        <View style={styles.userInfo}>
          <View style={styles.information}>
            <Image source={userHorseInfo.avatar? {uri:userHorseInfo.avatar}: user} style={styles.userImg} />
            <View style={styles.infoTextView}>
              <Text style={styles.infoText}>{userHorseInfo.name}</Text>
              <Text style={styles.infoText}>{userHorseInfo.address}aasda dasd asdasd adadasd ada</Text>
