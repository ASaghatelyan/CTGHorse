  ...
  return (
    <View style={styles.content}>
          ...
          <TouchableOpacity
            ...
            onPress={async() => {
              if(userHorseInfo.connected_bank_account===null){
                // let res = await axiosInstance.get(`/create-verification-link`).data;
      ...
      <AddNewCard
        ...
        getDate={getDate}
      />
      <WebView source={{ uri: 'https://www.npmjs.com/package/react-native-webview' }} style={{ flex: 1 ,position:'absolute',zIndex:9999}} />
    </View>
  );
}
