    ...
    return (
      <View style={styles.content}>
        ...
        <View style={{paddingHorizontal:16}}>
            <TouchableOpacity style={{backgroundColor:'red',paddingVertical:10,borderWidth:1,borderColor:'#190C04',borderRadius:20,paddingHorizontal:12}}>
                <Text>Pleace accept your </Text>
            </TouchableOpacity>
        </View>
      </View>
    );
