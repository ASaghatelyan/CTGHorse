    ...
    return (
      <View style={styles.content}>
        ...
        <View style={{paddingHorizontal:16}}>
            <TouchableOpacity style={{ paddingVertical:10,borderWidth:1,borderColor:'#190C04',borderRadius:8,paddingHorizontal:12}} onPress={()=>navigation.navigate('NewContract')}>
                <Text>Pleace accept your incoming contract</Text>
            </TouchableOpacity>
        </View>
      </View>
    );
