...
const chekChanges = ()=>{
  console.log(name,userInfo.name , address,userInfo?.address , phone,userInfo?.phone, email,userInfo.email,name===userInfo.name || address=== userInfo?.address || phone===userInfo?.phone || email===userInfo?.email);
