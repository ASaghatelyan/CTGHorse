...
export function ProfileScreen({navigation}) {
  ...
  const [starCount, setStarCount] = useState(userInfo?.rate);
        ...
        <View>
          ...
          <View style={styles.gFlex}>
            <View style={styles.addHorse}>
              {userInfo?.horses?.length===0 ?<Text style={styles.rateText}>
          ...
          <View style={styles.gFlex}>
            ...
            <TouchableOpacity 
               onPress={() => navigation.navigate('MyContracts')}style={styles.filterView}>
