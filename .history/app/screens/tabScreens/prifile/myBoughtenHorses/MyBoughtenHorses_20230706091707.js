    ...
    <View style={styles.content}>
      ...
      {boughtenHorses.length > 0 ? (
        ...
        <View style={styles.noHorseView}>
          ...
          Your Purchased Horses list is empty.cy-7mEbcLE50qYTKzURj1S:APA91bG_uhUtm5NKTrmpwAJ87kaBqjpoo8Pi6aGuK3gPzidD9iahSUF_JJ-BtTDXgRIpo3Q6nXEAN5q1egFlbfarxA40ei3JlK-hAYHa44Q8dBxj5UE2TrfrK21-FJEutYReLIwiIssz
          </Text>
        </View>
      )}
    </View>
