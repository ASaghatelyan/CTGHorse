    ...
    <View style={styles.content}>
      ...
      <ScrollView
        ...
        <View style={styles.filterBtn}>
          {(startDate || endDate) || status ? (
            <View style={styles.filterView}>
              <View style={styles.filterInfoView}>
        ...
        <View style={styles.transactionView}>
          {data?.map((item, index) => {
            return (
              <TouchableOpacity style={styles.transactionItem} key={index}>
                <View>
      ...
      {startDate || endDate || status ? null: <View style={styles.btnView}>
