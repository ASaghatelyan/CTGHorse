      ...
      <ScrollView
        ...
        <View>
          ...
          <TouchableOpacity style={styles.calView}>
            <TextInput placeholder='Select start date' value={startDate} editable={false} style={styles.input}/>
            <Image source={cal} style={styles.calendarIc} />
          </TouchableOpacity>
          <Text>End date</Text>
          <TouchableOpacity style={styles.calView}>
            <TextInput placeholder='Select end date' value={startDate} editable={false} style={styles.input}/>
            <Image source={cal} style={styles.calendarIc} />
          </TouchableOpacity>
        </View>
        <GButton
