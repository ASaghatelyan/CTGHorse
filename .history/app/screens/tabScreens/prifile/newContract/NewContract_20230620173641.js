...
export function NewContract({navigation}) {
  ...
  return (
    <View style={styles.content}>
      ...
      <View style={{position: 'absolute', zIndex: 999999, bottom: 30, width:'100%',alignItems:'center',paddingHorizontal:16}}>
 
        <GButton btnName="sfergstnr" handelMove={()=>{signature ? navigation.goBack() : a}}/>
      </View>
      <SignatureModal
        isVisible={singModal}
