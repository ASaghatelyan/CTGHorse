...
import {GButton, HeaderNavi, Input, LoadingModal, UpdatePassModal} from 'app/components';
...
export function ChangePassword({navigation}) {
  ...
  return (
    <KeyboardAvoidingView behavior="padding" style={{flex: 1}}>
      ...
      <UpdatePassModal isVisible={modalVisible} onClose={()=>setModalVisible(!modalVisible)} navigation={n} />
    </KeyboardAvoidingView>
  );
}
