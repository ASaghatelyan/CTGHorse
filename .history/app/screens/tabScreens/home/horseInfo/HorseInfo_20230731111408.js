      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{marginTop: 16}}>
        ...
        {!route.params.boughten && (
          <View style={styles.ownerTop}>
            ...
            {data[0]?.price !== 'Not For Sale' && subscription !== 'basic' && (
              <GButton
                btnName="Buy now"
            ...
            <View style={styles.deliveryView}>
              ...
              <Text style={styles.deliverySubTitle}>
                Please choose and contact a shipper for delivery
              </Text>
              <View>
                <TouchableOpacity
                  style={styles.yesNoView}
                  onPress={() => setDeliveryInfo(!deliveryInfo)}>
                  <Image
                    source={deliveryInfo ? off : on}
                    style={styles.onOff}
                  />
            ...
            {deliveryInfo && (
              <View style={styles.delCompInfo}>
                <Text style={styles.delCompTitle}>Eagleton Farm LLC</Text>
                <Text style={styles.delCompWeb}>Contact: Brian Eagleton</Text>
                <Text style={styles.delCompWeb}>832 338 5303</Text>
                <Text style={styles.delCompEmail}>eagletonfarm@gmail.com</Text>
                <Text style={styles.delCompWeb}>eagletonfarm.com</Text>
                <TouchableOpacity
                  style={styles.callView}
                  onPress={() => Linking.openURL(`tel:${'8323385303'}`)}>
                  <Image source={call} style={styles.callIc} />
                </TouchableOpacity>
              </View>
            )}
        ...
        {!route.params.boughten && more.length > 0 && (
          <Text style={[styles.title, {marginTop: GlobalHeight(32)}]}>
            More from {data[0].user.name}
          </Text>
        )}
        {!route.params.boughten && more.length > 0 && (
          <ScrollView
