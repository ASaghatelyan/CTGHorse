...
export function HorseInfo({navigation}) {
    ...
    <View style={styles.container}>
      <View style={styles.imageContainer}>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.backText}>Bacddk</Text>
        </TouchableOpacity>
        {likeDisLike ? (
          <TouchableOpacity
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{marginTop: 16}}>
        ...
        <View style={styles.ownerTop}>
          <TouchableOpacity style={styles.ownerView} onPress={()=>navigation.navigate('OwnerProfile')} >
          ...
          <GButton btnName="Buy now" customStyle={styles.custom} />
        </View>
        ...
        <ScrollView
          ...
          {data.map((item, index) => {
            return (
              <HorseItemHorizontal item={item} index={index} navigation={navigation} />
            );
          })}
        </ScrollView>
      </ScrollView>
