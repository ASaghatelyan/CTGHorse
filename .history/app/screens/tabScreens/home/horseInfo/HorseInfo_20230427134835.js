    ...
    <View style={[styles.container, {height: '100%'}]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{marginTop: 16}}>
        <View style={styles.infoView}>
          ...
          <View>
            <Text style={styles.titleName}>Reg N:</Text>
          ...
          <Text style={styles.titleName}>Color: {data[0]?.color}</Text>
          <Text style={styles.titleName}>Breed: {data[0]?.breed}</Text>
          {data[0]?.dam && (
            <Text style={styles.titleName}>Dam: {data[0]?.dam}</Text>
          )}
          {data[0]?.sire && (
            <Text style={styles.titleName}>Sire: {data[0]?.sire}</Text>
          )}
          <Text style={styles.titleName}>
          ...
          <Text style={styles.titleName}>Earnings: {data[0]?.earnings}</Text>
          <Text style={styles.titleName}>Height: {data[0]?.height}</Text>
          <Text style={styles.titleName}>Location: {data[0]?.location}</Text>
