...
export function HorseInfo({navigation, route}) {
  ...
  let getData = async () => {
    ...
    console.log(res.data,'res.data');
      setData(res,'dfghndfgv');
      setLikeDisLike(res.data[0][0].favorite);
      setMore(res.data[1]);
      setStarCount(res.data.user.rate);
      console.log(res.data[0][0].medias[0].url);
            ...
            <View style={styles.gFlex}>
              <View style={styles.picView}>
                ...
                <View>
                  ...
                  <Text style={styles.nameText}>{data?.[0]?.user.phone !=='null' && data?.[0]?.user.phone}</Text>
                  <StarRating
