      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{marginTop: 16}}>
        ...
        {!route.params.boughten && (
          <View style={styles.ownerTop}>
            <TouchableOpacity style={[styles.ownerView,data[0]?.price ==='Not For Sale' && {marginBottom:(30)}]} onPress={getOwnerData}>
              ...
              <View style={styles.gFlex}>
                <View style={styles.picView}>
                  ...
                  />
                  <View>
                    <Text style={styles.nameText}>{data?.[0]?.user.name} {data?.[0]?.user.surname}</Text>
         ...
         {data[0]?.price !=='Not For Sale' &&   <GButton
              btnName="Buy now"
