...
console.log(route.params,'dfsgb');
  return (
        ...
        <View style={styles.ownerView}>
          ...
          <View style={styles.gFlex}>
            <View style={styles.picView}>
              <Image source={route.params.avatar ? {uri:route.params.avatar} :owner} style={styles.ownerImg} />
              <View>
                <Text style={styles.nameText}>{route.params.name}</Text>
                <Text style={styles.contactType}>Contact: Phone Number</Text>
                <Text style={styles.nameText}>{route.params.phone}</Text>
                <Text style={styles.address}>Address: {route.params.address} dsavhjldfksxvajkdsvasldfn </Text>
