...
export function OwnerProfile({navigation, route}) {
  ...
  const [starCount, setStarCount] = useState(route.params.owner.owner.rate);
        ...
        <View style={styles.ownerView}>
          ...
          <View style={styles.gFlex}>
            <View style={styles.picView}>
              <Image
                source={
                  route.params.owner.avatar ? {uri: route.params.owner.avatar} : owner
                }
              ...
              <View>
                ...
                <Text style={styles.nameText}>
                  {route.params.owner.phone !== 'null' && route.params.owner.phone}
                </Text>
                <Text style={styles.address}>
                  Address:{' '}
                  {route.params.owner.address !== 'null' && route.params.owner.address}as as
                  as as asa s
                </Text>
                <Text style={styles.address}>Email: {route.params.owner.email}</Text>
