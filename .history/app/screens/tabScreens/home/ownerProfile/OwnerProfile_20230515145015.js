            ...
            <View style={styles.picView}>
              ...
              <View>
                ...
                <Text style={styles.address}>
                  Address:{' '}
                  {route.params.address !== 'null' && route.params.address}as as
                  as as asa s
                </Text>
                <Text style={styles.address}>Email: {route.params.email}</Text>
                <View style={{backgroundColor:'red',alignItems:'flex-start',justifyContent:'center', marginTop: GlobalHeight(8),}}>
                  <StarRating
