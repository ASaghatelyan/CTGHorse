...
export function PaymentMethod({navigation}) {
  ...
  return (
    <View style={styles.content}>
      ...
      <ScrollView
        ...
        {method.map((item, index) => {
          return (
            <TouchableOpacity key={item.id} style={styles.methodItem} onPress={()=>setChoosed(item.id)}>
   ...
   <GButton btnName="Add Payment Method" customStyle={styles.btn} handelMove={()=>navigation.navigat} />
      </ScrollView>
    </View>
  );
}
