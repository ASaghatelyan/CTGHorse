...
let next = ()=>{
  switch (activIndex) {
    case 1:
      return navigation.navigate('CardMethod', {horse:route.params.horse,method})
 
  }
}
console.log(route.params.horse,'ddd');
  return (
    <View style={styles.content}>
      ...
      <ScrollView
         ...
         */}
        <TouchableOpacity style={styles.methodItem} onPress={() => setActivIndex(0)}>
          <View style={styles.typeView}>
        ...
        <TouchableOpacity style={styles.methodItem} onPress={() => setActivIndex(1)}>
          <View style={styles.typeView}>
        ...
        <TouchableOpacity style={styles.methodItem} onPress={() => setActivIndex(2)}>
          <View style={styles.typeView}>
