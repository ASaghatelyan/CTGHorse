...
export function PaymentMethod({navigation}) {
  ...
  let addCard = async()=>{
    const apiKey = 'sk_test_51J7wyFCHIUiOha1H4f1HmTqcCoemMvYwoA87bMuPfpogAzLjUsMeCBbHB4NSVI0WEN772SnUwFrmsB51CHuKESlq00UjGJMnKZ';
  ...
  const cardData = await client.createToken(sendingData)
    const token = await client.createToken('4242424242424242' , '09', '24', '111');
console.log(token);
  }
  return (
