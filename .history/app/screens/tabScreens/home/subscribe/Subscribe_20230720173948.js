...
import {GButton, HorseItemComponent, LoadingModal, TabNaviTitle} from 'app/components';
...
export function Subscribe({navigation}) {
  ...
  const renderItem = ({item, index}, parallaxProps) => {
    return (
      ...
      <GButtom btnName="Subscribe"  handelMove={()=>navigation.replace('FirstLogin')}/>
    </View>
      </View>
    );
  };
