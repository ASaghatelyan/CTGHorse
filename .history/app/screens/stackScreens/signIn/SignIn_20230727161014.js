  ...
  let handleSingIn = async () => {
    ...
    try { 
      if (validateEmail(email) && password.length > 7) {
        ...
        console.log(res.data.user.subscribtion_expiration_date,'res.data.user');
        ...
        navigation.replace('Subscribe'):  navigation.replace('FirstLogin')
        }
    ...
    <KeyboardAvoidingView
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View>
          ...
          Please sign in with email address and password or sign up if first time user. 
          </Text>
        </View>
        {/* <Input
          title="Emails"
