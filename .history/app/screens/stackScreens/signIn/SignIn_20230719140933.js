...
import {ErrorModal, GButton, Input, InputHorseReg, LoadingModal} from 'app/components';
  ...
  return (
    <View
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        /> */}
         <TextInput placeholder='emmmaaaaa'/>
         <TextInput placeholder='passss'  secureTextEntry={true}/>
        {/* <Input
          title="Email"
          onChange={e => {
            setChoosed('');
