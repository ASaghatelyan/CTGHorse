...
export function SignUp({navigation}) {
  ...
  let handleSingUp = async () => {
    try {
      ...
      console.log(Object.keys(e.response.data.error), 'err');
      setChoosed(Object.keys(e.response.data.error)[0])
setErr( e.response.data.error.Object.keys(e.response.data.error)[0])
    }
  };
  console.log(err);
  return (
    <KeyboardAvoidingView
      ...
      <ScrollView>
        ...
        <Input
          ...
          err={
            (choosed === 'confirmPass' || choosed === 'notEqual') && err
          }
        />
