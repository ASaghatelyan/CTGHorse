...
export function HorseRegister(props) {
  ...
  const renderPages = () => {
    switch (percentage) {
      case 25:
        return (
          <HorseRegFirst onNextPrev={setPercentage} percentage={percentage} />
        );
      case 50:
        return (
          <HorseRegSecond onNextPrev={setPercentage} percentage={percentage} />
        );
      case 75:
        return <HorsRegThird onNextPrev={setPercentage} percentage={percentage}/>;
      case 100:
        return <HorseRegFourth onNextPrev={setPercentage} percentage={percentage}/>;
    }
  };
