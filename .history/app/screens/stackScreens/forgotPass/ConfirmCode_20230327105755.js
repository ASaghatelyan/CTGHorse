...
console.log( code,route.params.code,'route.params.code');
  const callme = () => {
      ...
      <ScrollView>
        ...
        <View style={{marginBottom: 32}}>
          <CodeInput
            ref={codeInputRef2}
            // secureTextEntry
            compareWithCode={`${route.params.code}`}
            activeColor="#190C04"
            ...
            onFulfill={isValid => {
              setChoosed(isValid);
              isValid ?  setCode(route.params.code) : setCode('')
            }}
          ...
          {choosed ? (
            ...
            <View style={styles.errView}>
              ...
              <Text style={styles.errText}>
                Code is not correct{' '}
                <Text style={styles.singUpText} onPress={()=>console.log();}> Resend Code</Text>
              </Text>
