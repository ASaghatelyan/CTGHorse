...
export const renderInputToolbar = props => {
  return !props.startRec ? (
    ...
    <View
      ...
      <AudioRecorder sendVoice={props.sendVoiceMessage} onCloseRec={props.onCloseRec} />
    </View>
  );
};
  ...
  return (
    <View
      style={[
        ...
        props.zoomInputActive ? {height: null, backgroundColor:'red'} : null,
      ]}>
      <Composer
        {...props}
        textInputStyle={[
