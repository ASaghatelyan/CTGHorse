...
import {InputToolbar, Actions, Composer, Send,LeftAction} from 'react-native-gifted-chat';
      ...
      <View style={styles.zoomButtonsContainer}>
        {canSendTextMessage ? (
          <Send
            ...
            <Image style={{width: 24, height: 24}} source={send} />
          </Send>
        ) : null}
      </View>
    </View>
