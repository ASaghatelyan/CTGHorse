...
export function BottomBtn({customStyles,onChangeL,nameL,onChangeR,nameR,activePassive}) {
  return (
    <View style={[styles.container, customStyles]}>
      ...
      <TouchableOpacity style={styles.btnViewR} onPress={activePassive?onChangeR:null} disabled={activePassive?true:false}>
     {!activePassive && <ActivityIndicator color={'#000'} style={styles.activePass}/>}
