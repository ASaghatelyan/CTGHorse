...
export const HorseItemComponent = ({item, index, owner, navigation,favorite,getFavorites}) => {
  const [likeDisLike, setLikeDisLike] = useState(favorite);

  useLayoutEffect(() => {
    setLikeDisLike(favorite);
  }, [!favorite]);
