...
export const HorseItemComponent = ({item, index,props,owner}) => {
  ...
  return (
    ...
    <DropShadow
      ...
      <TouchableOpacity onPress={() =>owner ? props.navigation.navigate('ChangeHorseInfo',{item}): props.navigation.navigate('HorseInfo')}>
        <View
          style={styles.listContainer}
          from={{opacity: 0, translateY: 50}}
          animate={{opacity: 1, translateY: 0}}
