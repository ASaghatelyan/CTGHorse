...
export function HorseItemHorizontal({item, index, owner, navigation}) {
  ...
  console.log(item?.medias?.[0].url, 'dfgasnd cdsbf b');
  return (
    <TouchableOpacity onPress={() => navigation.push('HorseInfo', item.id)}>
      <View
        ...
        <View style={styles.imageContainer}>
          <Image source={{uri: 'https://5704.freelancedeveloper.site/media/News_1681908327962/photos/4924D041-C98F-43F4-8FD2-361817768074.jpg'}} style={styles.image} />
        </View>
