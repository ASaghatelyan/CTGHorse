  ...
  useEffect(() => {
    if (searchText.length > 2) {
        let setTime = setTimeout(async () => {
            try {
                let response = await axiosInstance.get(`api/v1/player/?search=${searchText}`);
      ...
      <View
        ...
        <View style={styles.topView}>
          <View style={styles.inputView}>
            ...
            <TextInput style={styles.searchInput} value={searchText} onChangeText={text=>setSearchText(text)}/>
          </View>
