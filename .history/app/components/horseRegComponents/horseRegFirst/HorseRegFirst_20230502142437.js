...
export function HorseRegFirst({onNextPrev, percentage, navigation,color}) {
...
let a =async()=>{
  ...
  setColor({col1:result.background,col2:result.primary,col3:result.secondary})
...
console.log(color.col1);
  return (
    <LinearGradient colors={[color.col1,'#3b5998', '#192f6a']} style={{flex: 1,
      paddingLeft: 15,
      paddingRight: 15,
      borderRadius: 5}}>
