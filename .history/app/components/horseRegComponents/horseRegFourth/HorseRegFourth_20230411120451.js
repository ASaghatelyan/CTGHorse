...
console.log(store);
  ...
  formData.append('registration_number', store);
  formData.append('date_of_birth', store);
  formData.append('price', store);
  formData.append('sex', store);
  formData.append('height', store);
  formData.append('weight', store);
  formData.append('color', store);
  formData.append('discipline', store);
  formData.append('training', store);
  formData.append('earnings', store);
