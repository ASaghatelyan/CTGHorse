...
export function HorsRegThird({onNextPrev, percentage, setIndex}) {
  ...
  console.log(breedH , location && sexH && date &&
    heightH &&
      weightH &&
      colorH &&
      trainingH &&
  ...
  return (
    <View contentContainerStyle={styles.container}>
      ...
      />
      <View style={styles.gView}>
        {err && <Text style={styles.reqFields}>*</Text>}
