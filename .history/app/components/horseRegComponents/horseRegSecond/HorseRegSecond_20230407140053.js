...
export function HorseRegSecond(props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <InputHorseReg title="Name" value={name} onChange={(t)=>setName(t)} onSubmit={()=>console.log(name)}/>
      <InputHorseReg title="Enter Price" value={price} onChange={(t)=>setName(t)} onSubmit={()=>console.log(name)} />
    </View>
  );
}
