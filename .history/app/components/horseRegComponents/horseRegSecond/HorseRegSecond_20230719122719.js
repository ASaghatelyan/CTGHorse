      ...
      <View style={styles.container}>
        ...
        <View style={styles.forSaleView}>
          ...
          <View style={styles.infoView}>
            <TouchableOpacity style={styles.gFlex} onPress={()=>setChoosed('Yes')}>
              <Image source={choosed ==='Yes' ? off :off} style={styles.pic}/>
              <Text style={styles.text}>Yes</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.gFlex} onPress={()=>setChoosed('No')}>
