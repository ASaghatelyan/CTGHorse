...
export function HorseRegSecond({onNextPrev, percentage, navigation, setIndex}) {
  ...
  let taxPriceMore =typeof price == n Number((price * 5) / 100) + Number(price);
  let taxPriceLess = Number(500) + Number(price);

  let taxPrice = price < 10000 ? taxPriceLess : taxPriceMore;
  console.log('====================================');
