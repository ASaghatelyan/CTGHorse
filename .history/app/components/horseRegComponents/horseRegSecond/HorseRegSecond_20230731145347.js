...
export function HorseRegSecond({onNextPrev, percentage, navigation, setIndex}) {
  ...
  let taxPriceMore = typeof price == 'number' && Number((price * 5) / 100);
  let taxPriceLess = typeof price == 'number' && Number(500);
      ...
      <View style={styles.container}>
        ...
        {typeof price == 'number' && (
          <View style={styles.totalView}>
            <Text style={styles.totalText}>Total Price without Fee</Text>
            <Text style={styles.priceText}>${Math.floor(price-taxPrice)}</Text>
          </View>
        )}
      </View>
      <BottomBtn
