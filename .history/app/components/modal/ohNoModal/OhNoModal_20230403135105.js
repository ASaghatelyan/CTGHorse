    ...
    <Modal
      ...
      <View style={styles.container}>
        <View style={styles.contView}>
          ...
          <Text style={styles.titleTetx}>{title}s asdad asdasd asa dasd asd as dasd asdas as dsa sdasd </Text>
          <Text style={styles.infoText}>{infoText} sdfs sdf sf sdfsf sf ssf sd sd fsds df sdsdf sdf sdf sdsd fs</Text>
          {btns ? (
