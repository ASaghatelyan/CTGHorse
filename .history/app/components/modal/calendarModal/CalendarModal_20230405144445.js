...
export function CalendarModal({ isVisible, onClose,onDateInfo}) {
          ...
          renderHeader={date => {
            return (
              <View style={styles.calendarTitle}>
                <TouchableOpacity onPress={ onDateInfo}>
                ...
                {/* <View style={{flexDirection:'row',alignItems:'center'}}>
                  <TouchableOpacity onPress={_renderArrow}>
                    <Image source={Left} style={[styles.arrowIc,{marginRight:39}]} />
                  </TouchableOpacity>
                  <TouchableOpacity  onPress={_renderArrow}>
