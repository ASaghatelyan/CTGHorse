...
export default function DeliveryTabNavigation() {
  return (
    <View>
      <Text>DeliveryTabNavigation</Text>
    </View>
  )
}
      ...
      <Tab.Navigator
          ...
          options={({route}) => ({
            ...
            tabBarIcon: ({focused, color, size}) => {
              return (
                <View
                  ...
                  {focused ? (
                    <View style={{alignItems: 'center',minWidth:53}}>
                      <Image
                        style={{
                          height: 24,
                          width: 24,
            ...
            tabBarVisible: (route => {
              ...
              if (routeName === 'HorseInfo') {
               ...
               else if (routeName === 'CardMethod') {
                return false;
              }
               else if (routeName === 'OpenChat') {
                return false;
              }
              return true;
            })(route),
        ...
        <Tab.Screen
          ...
          options={({route}) => ({
            ...
            tabBarIcon: ({focused, color, size}) => {
              return (
                <View style={{alignItems: 'center', justifyContent: 'center',minWidth:53}}>
                  {focused ? (
          ...
          options={({route}) => ({
            ...
            tabBarVisible: (route => {
              ...
              if (routeName === 'SignIn') {
                ...
                return false;
              } else if (routeName === 'MyBoughtenHorses') {
                return false;
              } 
              else if (routeName === 'CardMethod') {
                return false;
              }
              else if (routeName === 'MyContracts') {
                return false;
              }
              else if (routeName === 'NewContract') {
                return false;
              }
